      ...
      <div className="w-full max-w-4xl flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <Link
              href="/wall"
              className="text-sm font-medium text-center text-(--capsule-ink) underline underline-offset-4 decoration-(--capsule-border) hover:decoration-(--capsule-ink) transition-colors py-2 sm:py-0"
            >
              View public wall →
            </Link>
